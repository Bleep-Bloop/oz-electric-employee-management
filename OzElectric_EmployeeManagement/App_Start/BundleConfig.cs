        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/template").Include(
              ...
              bundles.Add(new StyleBundle("~/Content/PublicCSS").Include( 
                        ...
                        "~/Content/CSS/Custom/skin-black.min.css",
                        "~/Content/CSS/Custom/skin-green.min.css",
                        "~/Content/CSS/Custom/skin-purple.min.css",
                        "~/Content/CSS/Custom/skin-red.min.css",
                        "~/Content/CSS/Custom/skin-yellow.min.css",
